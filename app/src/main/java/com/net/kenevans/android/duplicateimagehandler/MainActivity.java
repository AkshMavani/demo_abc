...
import com.example.demo_full.databinding.ActivityDeplicateBinding;

public class MainActivity extends AppCompatActivity implements IConstants {
    private String mDirectory;
    private ActivityDeplicateBinding mBinding;
...
//                                                (this));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = ActivityDeplicateBinding.inflate(getLayoutInflater());
