...
public class MyForeGroundService1 extends Service {
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            for (i = 0; i < times; i++) {
                ...
                Toast.makeText(MyForeGroundService1.this, info, Toast.LENGTH_SHORT).show();
                //toast(info);
            }
    ...
    void toast(final CharSequence text) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MyForeGroundService1.this, text, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            Toast.makeText(MyForeGroundService1.this, "The Intent to start is null?!", Toast.LENGTH_SHORT).show();
        }
    ...
    public Notification getNotification(String message) {
        ...
        return new NotificationCompat.Builder(getApplicationContext(), String.valueOf(MainActivity23.class))
                .setSmallIcon(R.mipmap.ic_launcher)
                .setOngoing(true)  //persistent notification!
                .setChannelId(String.valueOf(MainActivity23.class))
